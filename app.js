(function(){
  ...
  if('serviceWorker' in navigator){
    ...
    window.addEventListener('load',()=>navigator.serviceWorker.register('./sw.js?v=20260725r3',{updateViaCache:'none'}).then(reg=>reg.update()).catch(()=>{}));
  }
  route();
})();
